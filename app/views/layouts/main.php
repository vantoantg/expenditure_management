...
<nav class="navbar navbar-default">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><img src="<?= Helper::homeUrl()?>web/template/jobs/img/logo.jpg" style="max-height: 50px" alt=""></a>
        </div>
...
<div class="slider-area">
    <div class="slider">
        <div id="bg-slider" class="owl-carousel owl-theme">
            ...
            <div class="item"><img src="<?= Helper::homeUrl()?>web/template/jobs/img/slider-image-3.jpg" alt="Mirror Edge"></div>
            <div class="item"><img src="<?= Helper::homeUrl()?>web/template/jobs/img/slider-image-2.jpg" alt="The Last of us"></div>
            <div class="item"><img src="<?= Helper::homeUrl()?>web/template/jobs/img/slider-image-1.jpg" alt="GTA V"></div>
        ...
        <div class="row footer">
            <div class="col-md-4">
                <div class="single-footer">
                    <img src="<?= Helper::homeUrl()?>web/template/jobs/img/footer-logo.png" alt="" class="wow pulse" data-wow-delay="1s">
